...
class TopBlock(gr.top_block):
    ...
    def meta_save(self):
        ...
        np.savez(self.metadata_file,
                 data=np.array(str(datetime.date.today()),
                 start_time=np.array(self.start_time),
                 end_time=np.array(time.time()),
                 samp_rate=np.array(self.samp_rate),
                 frequency=np.array(self.c_freq),
                 vector_length=np.array(self.veclength),
                 int_length=np.array(self.int_length),
